...
const ProductCollection = () => {
    ...
    return (
        <div>
            <div className='text-center text-5xl font-bold'><h1>All {products[0].title} Products</h1></div>

            <div className='grid gap-8 sm:grid-cols-1 md:grid-cols-3 my-6 max-w-screen-xl mx-auto'>
                {
