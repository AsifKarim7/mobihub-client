...
const BookingModal = ({ product, setProduct }) => {
    ...
    const handleOrder = event => {
        ...
        fetch('https://mobihub-server-ecru.vercel.app/orders', {
            method: 'POST',
            headers: {
        ...
        <section>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <h3 className="text-xl text-[#2666CF] text-center font-bold">{name}</h3>
                    <form onSubmit={handleOrder} className='grid grid-cols-1 gap-2 mt-8'>
                        ...
                        <input type="submit" className='btn btn-primary text-white w-full' value="Submit" />
                    </form>
                </div>
            </div>
        </section>
